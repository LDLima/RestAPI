package Challenge.UdemyCourse.objects;

public class Account {
    /*
        It has to be with the same name as the paramaters in the web, otherwise, won't work;
        System does de association by itself when sending like an object!
        That's why it's in portuguese the names.
     */
    private Integer id;
